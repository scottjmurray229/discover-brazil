...
export const NETWORK_SITES: NetworkSite[] = [
  ...
  {
    id: 'brazil',
    name: 'Discover Brazil',
    shortName: 'Brazil',
    domain: 'discoverbrazil.info',
    url: 'https://discoverbrazil.info',
    flag: '\ud83c\udde7\ud83c\uddf7',
    region: 'south-america',
    status: 'live',
    tagline: 'Beaches, rainforest, and samba rhythms',
  },
  // Europe
  {
    id: 'eastern-europe',
...
export const CURRENT_SITE_ID = 'brazil';
