...
const GUIDE_NAMES: Record<string, string> = {
  'destination-rio-de-janeiro': 'Rio de Janeiro Travel Guide',
  'destination-sao-paulo': 'S\u00e3o Paulo Travel Guide',
  'destination-salvador': 'Salvador Travel Guide',
  'destination-florianopolis': 'Florian\u00f3polis Travel Guide',
  'destination-iguazu-falls': 'Iguazu Falls Travel Guide',
  'destination-brasilia': 'Bras\u00edlia Travel Guide',
  'destination-manaus': 'Manaus Travel Guide',
  'destination-recife': 'Recife Travel Guide',
  'destination-paraty': 'Paraty Travel Guide',
  'destination-ouro-preto': 'Ouro Preto Travel Guide',
  'destination-jericoacoara': 'Jericoacoara Travel Guide',
  'destination-fernando-de-noronha': 'Fernando de Noronha Travel Guide',
  'destination-bonito': 'Bonito Travel Guide',
};
  ...
  <div style="max-width:560px;margin:0 auto;padding:40px 24px;">
    <div style="background:white;border-radius:16px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
      <div style="background:linear-gradient(135deg,#0D7377,#14B8A6);padding:32px 28px;text-align:center;">
        <h1 style="color:white;font-size:24px;margin:0 0 8px;">Discover Brazil</h1>
      ...
      <div style="padding:28px;">
        <p style="color:#1A2332;font-size:16px;line-height:1.65;margin:0 0 16px;">
          Welcome! You're now part of the Discover Brazil community.
        </p>
        ...
        <div style="text-align:center;margin-bottom:24px;">
          <a href="https://discoverbrazil.info/destinations/" style="display:inline-block;background:#0D7377;color:white;padding:12px 28px;border-radius:8px;text-decoration:none;font-weight:600;font-size:15px;">Browse All Destinations</a>
        </div>
    ...
    <p style="color:#94A3B8;font-size:11px;text-align:center;margin:20px 0 0;line-height:1.5;">
      You're receiving this because you signed up at discoverbrazil.info.<br>
      <a href="https://discoverbrazil.info/legal/privacy/" style="color:#94A3B8;">Privacy Policy</a>
    </p>
  </div>
</body>
</html>`;
...
async function sendWelcomeEmail(apiKey: string, to: string, guideName: string): Promise<void> {
  const res = await fetch('https://api.resend.com/emails', {
    ...
    body: JSON.stringify({
      ...
      to: [to],
      subject: `Your ${guideName} — Welcome to Discover Brazil`,
